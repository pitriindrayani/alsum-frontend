...
export default function DataTahunAjaran() {
  document.title = "Data Tahun Ajaran";
  ...
  const deleteById = async (id) => {
    Swal.fire({
      ...
      if(result.isConfirmed) {
        const response =  await APILA.delete(`/api/semesters/${id}`,fetchParams);
            ...
            {isTabletOrMobile ? 
              <>
                <div className="title-page">
                  <h6> <FontAwesomeIcon icon={faListUl} /> Data Tahun Ajaran</h6>
                </div> 
                
                <div className="ml-auto">
                  <button onClick={viewModalAdd} className="btn btn-create"> <FontAwesomeIcon icon={faPlus} />Tahun Ajaran</button>
                </div>
              </>
                : 
              <>
                <div className="title-page">
                  <h5> <FontAwesomeIcon icon={faListUl} /> Data Tahun Ajaran </h5>
                </div>
          
                <div className="ml-auto">
                  <button onClick={viewModalAdd} className="btn btn-create"> <FontAwesomeIcon icon={faPlus} /> Tambah Tahun Ajaran</button>
                </div>
              </>
            }
          ...
          {/* <div className="breadcrumb-header mb-4" style={{fontSize:"14px" }}>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item active" aria-current="page"> kelas</li>
                            ...
                            {getData.map((kelas,index) => (
                              <tr key={index}>
                                ...
                                <td style={{ lineHeight: "2" }}> 
                                 ...
                                 {/* <td style={{ color: item.value > 10 ? 'green' : 'red' }}>
                                  {item.value > 10 ? 'High' : 'Low'} 
                                </td> */}
                                <td style={{ lineHeight: "2" }}> 
                                ...
                                <td >
                                  <button className="button-edit button-table" onClick={() => viewModalUpdate(kelas?.id, kelas)} > <FontAwesomeIcon icon={faPenToSquare} />
                                  </button>
                                  <button className="ml-2 button-delete button-table" onClick={() => {deleteById(kelas?.id)}}> <FontAwesomeIcon icon={faTrash} />
                                  </button>                           
