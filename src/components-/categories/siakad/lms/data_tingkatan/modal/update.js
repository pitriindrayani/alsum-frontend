...
export default function DataTingkatanUpdate(props) {
  ...
  useEffect(() => {
    setForm({
    ...form,
      name_level: safeValue(props?.dataUpdate?.name_level),
  ...
  const handleSubmit = useMutation(async (e) => {
    try {
      ...
      const response = await APIMS.put(`/api/grade-levels/${props.id}`, {
    ...
    <div className="modal">
      ...
      <Form onSubmit={(e) => handleSubmit.mutate(e)}  >
         <div className="mt-4 label-group-form" >
            ...
            <input  className="label-input-form"  type='text' name="name_level" onChange={handleChange} value={form?.name_level}  
              placeholder='...' />
