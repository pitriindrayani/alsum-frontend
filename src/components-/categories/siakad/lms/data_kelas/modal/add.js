...
export default function DataKelasAdd(props) {
  ...
  const handleSubmit = useMutation(async (e) => {
    try {
      ...
      const response = await APIMS.post("/api/kelas/store", {
    ...
    <Modal {...props} size="md" aria-labelledby="contained-modal-title-vcenter" centered >  
      ...
      <Form onSubmit={(e) => handleSubmit.mutate(e)}  >
          ...
          <div className="mt-4 label-group-form" >
            ...
            <input className="label-input-form" autoFocus type='text' name="number_kelas" onChange={handleChange} placeholder='...'/>
          ...
          <div className="mt-4 label-group-form" >
            ...
            <input  className="label-input-form"  type='name_kelas' name="name_kelas" onChange={handleChange} placeholder='...' />
            <style>{`input::placeholder { color: #B9B9B9;}`}</style>
          </div>
