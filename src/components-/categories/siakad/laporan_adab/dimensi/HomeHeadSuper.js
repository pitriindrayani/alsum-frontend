...
//       ]);
//       if (dataSemester.status === 200  && dataBranch.status === 200  &&  dataDimensi.status === 200){
  ...
  return (
    ...
    <div className="body-content">
        ...
        <div className='d-flex mb-4'>
            <div>
                <button  className=" btn " style={{fontSize: '15px', padding:'5px 10px', marginTop: '-2px', borderRadius:"0"}}> <Link style={{textDecoration: "none", color: "#327dffff"}} to="/element-recaps-dimensi">Penilaian Guru</Link> </button>
            </div>
            <div className='ml-2'>
                <button  className=" btn " style={{fontSize: '15px', padding:'5px 10px', marginTop: '-2px', borderRadius:"0", backgroundColor:"#076db5ff", color: "#fff"}}>Penilaian Kepala Sekolah</button>
            </div>
        </div>
          ...
          <>
            <div className="mb-3 mt-4">
              ...
              <div className='mt-3 d-flex'>
                ...
                <button className="btn ml-2" style={{fontSize: '13px', padding:'5px 10px', marginTop: '-2px', borderRadius:"3px", backgroundColor:"#1ab4ecff", color: "#fff"}}> Kunci Nilai </button>
                      ...
                      <thead>
                        <tr>
                          {/* Header kosong untuk kolom header samping */}
                            ...
                            <th className="border border-gray-300 p-3 bg-gray-100 text-center">Rata-Rata Penilaian Guru</th>
