...
export default function Leger() {
  ...
  const GetResponseData = async () => {
    try {
      ...
      const response = await APILA.get('/api/element-recaps-leger/leger', {
        params: {
        ...
        {isTabletOrMobile ? 
          <>
            <div className="title-page">
              <h6><FontAwesomeIcon icon={faListUl}/> Leger</h6>
            </div> 
          </>
          : 
          <>
            <div className="title-page">
              <h5><FontAwesomeIcon icon={faListUl}/> Leger </h5>
            </div>
          </>
        }   
      </div> 
        ...
        {/* <div className="breadcrumb-header mb-4" style={{fontSize:"14px" }}>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item"> Leger</li>
            </ol>
          </nav>
        </div> */}
                    ...
                    <table className="table table-laporan-adab table-hover table-bordered " id="basic-datatable">
                      <thead>
                        <tr>
                          ...
                          <th style={{textAlign: "center", border: "1px solid #e0e0e0ff"}}>Nilai</th>
                          <th style={{textAlign: "center", border: "1px solid #e0e0e0ff"}}>KKCA</th>
                          <th style={{textAlign: "center", border: "1px solid #e0e0e0ff"}}>Deskripsi</th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        {element?.rekapan?.map((rekap) => (
                          <tr key={rekap?.ysb_element_recap_id}>
                            ...
                            <td style={{ lineHeight: "2", textAlign: "center" }}>{Math.round(rekap?.average * 10) / 10 }</td>
                            <td style={{ lineHeight: "2", textAlign: "center" }}>{rekap?.kkca_description}</td>
                            <td style={{ lineHeight: "2", textAlign: "center" }}>{rekap?.kkca_description_full}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
