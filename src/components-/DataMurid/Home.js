    ...
    <div className="body" >
      ...
      <div className="body-header d-flex">
            ...
            {isTabletOrMobile ? 
              ...
              <>
                <div className="title-page">
                  <h5> <FontAwesomeIcon icon={faListUl} /> Data Murid</h5>
                </div>
          ...
          {/* <div className="breadcrumb-header mb-4" style={{fontSize:"14px" }}>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item active" aria-current="page"> murid</li>
                        ...
                        <tbody>
                            ...
                            {getData.map((murid,index) => (
                              <tr key={index}>
                                ...
                                <td style={{ lineHeight: "2" }}> 
                                  {murid.number_kelas} - {murid.name_kelas}
                                </td>
                                <td style={{ lineHeight: "2" }}> 
                                  {murid.name_school}
                                </td>
                                ...
                                <td >
                                  <button className="button-edit button-table" onClick={() => viewModalUpdate(murid?.id, murid)} > <FontAwesomeIcon icon={faPenToSquare} />
                                  </button>
                                  <button className="ml-2 button-delete button-table" onClick={() => {deleteById(murid?.id)}}> <FontAwesomeIcon icon={faTrash} />
                                  </button>                           
