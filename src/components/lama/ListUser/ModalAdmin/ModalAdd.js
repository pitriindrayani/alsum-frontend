...
export default function ModalRoleAdd(props) {
  ...
  const handleSubmit = useMutation(async (e) => {
    try {
      ...
      const response = await API.post("/api/privileges/users/store", {
      ...
      <Form onSubmit={(e) => handleSubmit.mutate(e)} className="mt-1" >
        <div className="mt-4" style={{ display: "flex"}}>
            <div style={{ display:"flex", width:"100%"}}>
              <select  ref={nameInputRef}  aria-label="Default select example" onChange={handleChange} name="level" style={{color:"#2e649d", textAlign:"", cursor:"pointer", border:"2px solid #2e649d"
          ...
          <div className="mt-4" style={{ display: "flex"}}>
            <div style={{ display:"flex", width:"100%"}}>
              <select aria-label="Default select example"  onChange={handleChange}  name="id_role" style={{color:"#2e649d", textAlign:"", 
          ...
          <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='text' name="username" onChange={handleChange} value={username}  
          ...
          <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='email' name="email" onChange={handleChange} value={email}  
          ...
          <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='password' name="password" onChange={handleChange} value={password}  
          ...
          {/* <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='number' name="unique_id" onChange={handleChange} value={unique_id}  
          ...
          {/* <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='text' name="address" onChange={handleChange} value={address}  
          ...
          {/* <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='number' name="phone_number" onChange={handleChange} value={phone_number}  
          ...
          {/* <div className="mt-4" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between', 
            ...
            <input autoFocus type='text' name="birth_place" onChange={handleChange} value={birth_place}  
          ...
          <div className="mt-4" style={{ display: "flex"}}>
            <div style={{ display:"flex", width:"100%"}}>
              <select  aria-label="Default select example"  onChange={handleChange} name="gender" style={{color:"#2e649d", textAlign:"", cursor:"pointer", border:"2px solid #2e649d"
               ,width:"100%", height:"45px", borderRadius:"5px"
              }}>
