...
export default function ModalRoleAdd(props) {
  ...
  useEffect(() => {
    setForm({
      ...
      in_time               : `${props?.startTimeAdd === null? "" : props?.startTimeAdd}`,
      out_time              : `${props?.endTimeAdd === null? "" : props?.endTimeAdd}`,
      ...
      total_koreksi_absen   : `${props?.dateRangeAdd?.total_koreksi_absen}`,
      tipe_koreksi          : "",
      late_min              : "",
      early_min             : "",
      absent_type           : "",
  ...
  const handleSubmit = useMutation(async (e) => {
    e.preventDefault();
    if (form?.absent_type === "3" && form?.total_koreksi_absen > 1 && form?.tipe_koreksi === "masuk_pulang") {
      Swal.fire(
    ...
    if (form?.absent_type === "9" && (form?.total_koreksi_absen > 1 && form?.total_koreksi_absen < 3) && form?.tipe_koreksi === "masuk_pulang_kampus" &&
  ...
  useEffect(() => {
    if(form?.absent_type === 9 || form?.absent_type === "9"){
      setForm({
        ...form, 
        in_time_hours     : `${props?.startTimeAdd === null? props?.inScheduleAdd.split(':')[0] : props?.startTimeAdd.split(':')[0]}`,
        in_time_minute    : `${props?.startTimeAdd === null? props?.inScheduleAdd.split(':')[1] : props?.startTimeAdd.split(':')[1]}`,
  ...
  useEffect(() => {
    if(form?.absent_type === 10 || form?.absent_type === "10"){
      setForm({
        ...form, 
        in_time_hours     : `${props?.startTimeAdd === null? props?.inScheduleAdd.split(':')[0] : props?.startTimeAdd.split(':')[0]}`,
        in_time_minute    : `${props?.startTimeAdd === null? props?.inScheduleAdd.split(':')[1] : props?.startTimeAdd.split(':')[1]}`,
      ...
      <Form onSubmit={(e) => handleSubmit.mutate(e)} className="" >
          <div className="" style={{ display: "flex"}}>
            <div style={{ display:"flex", width:"100%"}}>
              <select ref={nameInputRef} aria-label="Default select example"  onChange={handleChange} value={form?.absent_type}  name="absent_type" style={{color:"#2e649d", textAlign:"", 
                ...
                {form?.day === "Sabtu" || form?.day === "Minggu" || form?.day_libur === "1"?
                <>
        ...
        {(form?.absent_type === "3" && 
         ...
         (form?.absent_type === "3" && 
          ...
          {form?.absent_type === "6" || form?.absent_type === "7" || form?.absent_type === "8" || form?.absent_type === "9" || form?.absent_type === "10" ?
          <div className="mt-3">
