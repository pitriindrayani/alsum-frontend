...
export default function Login() {
  ...
  const [dayLiburAdd, setDayLiburAdd] = useState();
  ...
  const viewModalAdd = (dataTeacher, date_range, date, day, day_libur, start_time, end_time, duration_attendance,
  ...
  today.setHours(today.getHours() - 27);
  ...
  return (
    <div style={{ backgroundColor: "white"}}>
      ...
      dateAdd={dateAdd} dayAdd={dayAdd} dayLiburAdd={dayLiburAdd} startTimeAdd={startTimeAdd} endTimeAdd={endTimeAdd} durationAttendanceAdd={durationAttendanceAdd}
        ...
        <div>
          ...
          <tbody style={{
            ...
            {getData?.date_range.map((d, index) => {
                ...
                // const now = new Date(); 
                // const currentDateWithTimeNow = new Date(
                ...
                if (d.attendance_daily !== null) {
                  ...
                  }else if(approve_hr === 0 && approve_head_school === 1 && getData?.fg_active === 0){
                    actionContent = <td style={{textAlign: "center",wordWrap: "break-word",minWidth:"120px",maxWidth: "120px" }}>Proses Hr</td>;
                  }else if(approve_hr === 0 && approve_head_school === 1 && getData?.fg_active === 1){
                    actionContent = <td style={{textAlign: "center",wordWrap: "break-word",minWidth:"120px",maxWidth: "120px" }}>Proses Hr</td>;
                  }else if(approve_hr === 0 && approve_head_school === 0 && getData?.fg_active === 0){
                    actionContent = <td style={{textAlign: "center",wordWrap: "break-word",minWidth:"120px",maxWidth: "120px" }}>Proses Kepsek</td>;
                  }else if(approve_hr === 0 && approve_head_school === 0 && getData?.fg_active === 1){
                    actionContent = (
                      <td style={{ textAlign: "center",wordWrap: "break-word",minWidth:"120px",maxWidth: "120px" }}>
                        <button
                          onClick={() => {deleteById(d?.attendance_daily.id)}}
                          style={{padding: "5px 15px",fontSize: "11px",backgroundColor: "rgb(253, 42, 42)",
                          border: "1px solid rgb(253, 42, 42)",borderRadius: "3px",color:"white",cursor: "pointer"}}>
                          Batal
                        </button>
                      </td>
                    );
                  }
                }else if(currentDate <= today && getData?.fg_active === 1) {
                  ...
                  actionContent = (
                    <td style={{ textAlign: "center",wordWrap: "break-word",minWidth:"120px",maxWidth: "120px" }}>
                      <button
                        onClick={() =>
                          viewModalAdd(
                            getDataTeacher, getData, d?.date, d?.day, d?.day_libur, d?.start_time, d?.end_time,
