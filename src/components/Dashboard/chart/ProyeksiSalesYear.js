...
const ProopsHome = ({year, month}) => {
  ...
  <>
    ...
    <CardHeader className='d-flex justify-content-between align-items-sm-center align-items-start flex-sm-row flex-column'>
        <CardTitle tag='p'>Proyeksi Sales Tahun {year}</CardTitle>
      </CardHeader>  
                  ...
                  <div className="columns">
                    <div className="column is-centered">
                      <form onSubmit={searchData}>
                        <div className="field has-addons">
                          ...
                          <div className="control">
                            <button type="submit" className="button is-info" style={{backgroundColor:"#80ff00"}}>
                              Search
                            </button>
                          </div>
                        </div>
                      ...
                      <table className="table is-striped is-bordered  mt-2">
                        <thead>
                          <tr>
                            <th style={{textAlign:"center", fontSize:"10px", backgroundColor:"#80ff00"}}>No</th>
                            <th style={{textAlign:"center",fontSize:"10px",backgroundColor:"#80ff00"}}>Customer</th>
                            <th style={{textAlign:"center",fontSize:"10px",backgroundColor:"#80ff00"}}>Total</th>  
