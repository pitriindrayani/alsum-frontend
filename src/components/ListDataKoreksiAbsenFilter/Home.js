...
export default function Login() {
  ...
  const GetResponseData = async () => {
    try {
      // e.preventDefault();;
      setLoading(true)
      const response = await API.post(`/api/attendance-dailys-filter`, {
  ...
  const approveHeadSchool = async (id) => {
    Swal.fire({
      ...
      if(result.isConfirmed) {
        const response =  await API.delete(`/api/attendance-dailys-filter/approve-head-school/${id}`,fetchParams);
  ...
  const cancelApproveHeadSchool = async (id) => {
    Swal.fire({
      ...
      if(result.isConfirmed) {
        const response =  await API.delete(`/api/attendance-dailys-filter/cancel-head-school/${id}`,fetchParams);
        if (response.data.error == false) {
          GetResponseData()
          swal({
            title: 'Success',
  ...
  const approveHr = async (id) => {
    Swal.fire({
      ...
      if(result.isConfirmed) {
        const response =  await API.delete(`/api/attendance-dailys-filter/approve-hr-school/${id}`,fetchParams);
        if (response.data.error == false) {
          GetResponseData()
          swal({
            title: 'Success',
  ...
  const cancelApproveHr = async (id) => {
    Swal.fire({
      ...
      if(result.isConfirmed) {
        const response =  await API.delete(`/api/attendance-dailys-filter/cancel-hr-school/${id}`,fetchParams);
        if (response.data.error == false) {
          GetResponseData()
          swal({
            title: 'Success',
  ...
  const approveHrAll = async () => {
      Swal.fire({
        ...
        if(result.isConfirmed) {
          const response =  await API.put(`/api/attendance-dailys-filter/approve-hr-all`,{selectedRows : selectedRows},fetchParams);
          if (response.data.error == false) {
            GetResponseData()
            setSelectedRows([])
            swal({
  ...
  const approveHeadSchoolAll = async () => {
    Swal.fire({
      ...
      if(result.isConfirmed) {
        const response =  await API.put(`/api/attendance-dailys-filter/approve-head-all`,{selectedRows : selectedRows},fetchParams);
        if (response.data.error == false) {
          GetResponseData()
          setSelectedRows([])
          swal({
